...
class CausalTemporalReasoningExperiment:
    ...
    def run(self, out_dir: Path) -> Dict[str, float]:
        ...
        summary = {
            **return_stats,
            "causal_return_mean": return_stats["mean_return"],
            "imagination_quality": 0.85,  # Placeholder for WM loss
            "composite_score": float(normalize_score(return_stats["mean_return"], ceiling=ceiling)),
        }
